...
export function AddDealButton({ options }: AddProps) {
  ...
  return (
    <>
      <button
        onClick={() => setOpen(true)}
        className="flex items-center gap-2 bg-indigo-600 hover:bg-indigo-700 text-white text-sm font-medium px-4 py-2 rounded-full shadow-sm transition-colors shrink-0"
      >
        <Plus size={18} />
        Add Deal
      </button>
